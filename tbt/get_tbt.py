...
def main():
    ...
    tbt_pv = [
        epics.PV(bpm_prefix+'TBT:A:Buff-Wfm'),
        epics.PV(bpm_prefix+'TBT:B:Buff-Wfm'),
        epics.PV(bpm_prefix+'TBT:C:Buff-Wfm'),
        epics.PV(bpm_prefix+'TBT:D:Buff-Wfm'),
        epics.PV(bpm_prefix+'TBT:X:Buff-Wfm'),
        epics.PV(bpm_prefix+'TBT:Y:Buff-Wfm')]
